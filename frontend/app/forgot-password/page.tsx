    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="flex-1 bg-surface flex flex-col">
        ...
        <div className="lg:hidden flex items-center justify-between px-6 py-5 border-b border-border">
          <Link href="/">
            ...
            <div className="text-[11px] font-sans font-semibold uppercase tracking-[0.22em] text-muted mt-0.5">
              Executive Careers
            </div>
          </Link>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-between px-6 py-12 sm:px-12 lg:px-16 xl:px-20">
          ...
          <div className="hidden lg:block">
            <Link href="/">
              ...
              <div className="text-[11px] font-sans font-semibold uppercase tracking-[0.26em] text-muted mt-1">
            ...
            {submitted ? (
              ...
              <div>
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-7">
                  <div>
                    <label htmlFor="email"
                      className="block text-[12px] font-sans font-semibold uppercase tracking-[0.2em] text-muted mb-3">
                      Email Address
                    </label>
                    <input
                      ...
                      className={`w-full px-0 pb-3 pt-1 text-[16px] font-sans text-charcoal placeholder-muted-light bg-transparent border-0 border-b focus:outline-none transition-colors duration-200 ${
                        error ? "border-red-400" : "border-border focus:border-navy"
                      }`}
                    />
                    {error && (
                      <p className="mt-2 flex items-center gap-1.5 text-[13px] font-sans text-red-600">
                  ...
                  <div className="pt-2">
                    <button type="submit" disabled={loading}
                      className="w-full py-3.5 text-[13px] font-sans font-semibold uppercase tracking-[0.22em] text-surface bg-navy hover:bg-navy-mid active:bg-charcoal disabled:opacity-60 transition-colors duration-150 focus:outline-none">
          ...
          <div className="hidden lg:block">
            <p className="text-[13px] font-sans text-muted/50">
      ...
      <div className="hidden lg:flex lg:w-[46%] xl:w-[48%] bg-navy flex-col justify-between p-14 xl:p-16 relative overflow-hidden">
        ...
        <div className="relative">
          <p className="text-[11px] font-sans font-semibold uppercase tracking-[0.3em] text-brass">
            Account Security
          </p>
        </div>
        ...
        <div className="relative">
          <p className="text-[14px] font-sans text-navy-text-dim">
            ...
            <Link href="/login"
              className="text-navy-text hover:text-brass underline-offset-4 hover:underline transition-colors">
              Sign in instead →
            </Link>
          </p>
        </div>
